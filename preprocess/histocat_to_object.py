...
def histocat_to_object (image_path,remove_dna=True,remove_string_from_name=None,
                        islog=True,drop_markers=None,random_sample=None,CellId='CellId',split='Area'):
    """
